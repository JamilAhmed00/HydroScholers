...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Clean Water & Senitation!!!": [["pollution", "safe water", "senitation", "hand wash"],
			["virus", "bacteriam", "project", "global"],
			["distroy", "river", "sea", "life"],
			["fresh water", "reuse", "safe", "scarcity"],
			["humanbeing",  "chemical",  "target", "goal"]]
